...
人类=人形 chibi。
【Q版生成六硬规范·2026-09-01 用户实测整改】①发型显式锁:发色+发型词与 image_prompt
逐字一致(如 dyed yellow slicked-back hair,禁止只写 short hair 无颜色——无颜色词=空锁,
模型自由发挥发色);②辨识特征≥2:发型细节/配饰/服装纹样/五官差异至少 2 个独有特征
(防撞脸,同模板的年轻男性 Q 版高度相似);③形态构成:3-head-tall+大头占半身+短手短脚+
大亮眼(禁止只写 3-head-tall——人物太大实锤);④禁违禁物品:禁止 cigarette/smoking/
alcohol/酒 等烟酒及管制物品;⑤同一人:与正面定妆照形象一致(发型/发色/服装/配饰);
⑥比例:大头小身呆萌,人物占画面约 60%。
