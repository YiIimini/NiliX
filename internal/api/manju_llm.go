  ...
  "shots": [
    {
      ...
      "narration": "旁白（仅原文叙述性文字/画外音，逐字引用）。【硬约束】旁白禁止包含任何角色的台词——角色说的每句话必须放进 dialogue 并标注对应角色；原文中\"XXX说\"的对白必须标为该角色 dialogue；无旁白则空；有台词时旁白留空避免重复。【内心独白标记·强制】原文角色内心/心理活动(心想/暗道/嘀咕/盘算等)写 内心·角色名:原文内心内容(渲染时画面用该角色 Q 版呆萌形象+画外音,2026-08-23 用户规则;【Q版纪律·2026-09-01 用户规则最终版】仅正角(女主/男主/正角)内心独白用 Q 版形象渲染;反派/功能配角/群演内心=该角色写实正脸图+画外音(Q 版资产仅正角生成)),与客观旁白区分",
      "duration": 5
    }
  ],
  "directing": {
  ...
  "shots": [
    {
      ...
      "narration": "旁白（画外音，脚本原文；无则空；有台词时旁白留空避免重复）。【内心独白标记·强制】脚本原文角色内心/心理活动写 内心·角色名:内容(渲染时画面用该角色 Q 版呆萌形象+画外音,2026-08-23 用户规则;【Q版纪律·2026-09-01 用户规则最终版】仅正角(女主/男主/正角)内心独白用 Q 版形象渲染;反派/功能配角/群演内心=该角色写实正脸图+画外音(Q 版资产仅正角生成)),与客观旁白区分",
      "duration": 5,
