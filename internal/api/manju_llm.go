...
{
  "episode_title": "集标题",
  "characters": [{"id": "角色名", "gender": "男/女", "age": "年龄段", "appearance": "完整外观（发型/脸型/五官/气质，从脚本提取并补全，具体到可渲染）", "costume": "完整服装描述", "image_prompt": "给图片模型的英文文生图提示词（半身立绘，` + assetStyle + ` 风格，正面正脸、头部完整居中（含发顶到下巴），含完整外观/服装/性别强化）", "views": {"front": "英文文生图提示词：正面特写（头肩构图，正脸居中含发顶到肩，面部五官/发型/领口细节清晰，` + assetStyle + ` 风格）", "full": "英文文生图提示词：全身立绘（完整头到脚，正面站姿，完整服装/鞋履/体态，` + assetStyle + ` 风格）", "side": "英文文生图提示词：侧面轮廓（侧脸 90 度，发型/脸型/服装侧面轮廓清晰，` + assetStyle + ` 风格）", "detail": "英文文生图提示词：细节特写（该角色最有辨识度的 1 个细节：饰品/花纹/发饰/疤痕等，大特写构图，` + assetStyle + ` 风格）"}}],
