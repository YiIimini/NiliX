...
func TestManjuVoicePhraseFor(t *testing.T) {
	cases := map[string]string{
		"male_elder":    "an old man's voice, weathered and kind",
		"female_elder":  "an elderly woman's voice, warm and crackly",
		"child_girl":    "a little girl's voice, sweet and bouncy",
		"male_sun":      "a young man's voice, warm and easygoing",
		"male_mag":      "a middle-aged man's voice, deep and unhurried",
		"beast_cute":    "a cute chirpy creature voice",
		"unknown_key":   "",
	}
